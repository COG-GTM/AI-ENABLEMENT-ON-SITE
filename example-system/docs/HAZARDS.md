...
| SN-HAZ-002 | Temperature sensor returns out-of-range value (bus glitch) | Wrong temperature used downstream | 2 | 3 | 6 | Range check, keep last valid value, set FAULT (SN-REQ-007) | `test_node.test_out_of_range_temp_sets_fault_and_keeps_last_valid`, C `test_temp_fault` | Mitigated |
