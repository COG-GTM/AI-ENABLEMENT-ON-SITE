...
| --- | --- | --- |
| LabVIEW on some machine | `File > Print... > HTML`, include block diagram and connector pane. That is `example-system/bench/rig.vi.html` | Read every control, indicator, constant, structure, and SubVI name; build the inventory |
...
`example-system/bench/RIG-REVIEW.md`; yours will look like it.
